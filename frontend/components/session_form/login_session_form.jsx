                            ...
                            <form onSubmit={this.handleSubmit} className="form">
                                ...
                                <div className="form-label-container">
                                    ...
                                    <div className="submit-button-container">
                                        <input id="session-submit" className="submit-button" type="submit" value="Login" />
                                    </div>
                                    ...
                                    <div className="submit-button-container">
                                        <button className="submit-button" onClick={this.demoLogin} >Demo Login</button>
                                    </div>
                        ...
                        <div className="download-link-container">
                            ...
                            <div className="download-link-container-box">
                                <a  
                                    ...
                                    <img 
                                        src={window.images.apple} 
                                        alt="apple logo" 
                                        className="download-link-image" 
                                    />
                                </a>
